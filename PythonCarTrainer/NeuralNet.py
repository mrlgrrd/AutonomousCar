...
class NeuralNet:
    ...
    #This function calculates an output from the input passed as a parameter.
    ...
    def perturbWeights(self):
        ...
        for i in range(len(weightVector)):
            weightVector[i]+= numpy.random.normal(0.0, 0.02) #numpy.random.uniform(0.0,0.05)-numpy.random.uniform(0.0,0.05)
